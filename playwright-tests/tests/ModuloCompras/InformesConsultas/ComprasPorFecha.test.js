...
test.describe.serial('Compras por fecha', () => {
  let page;
  let context;
  let iframe;
  ...
  test.beforeEach(async () => {
    ...
    await comprasPage.goToInformesYconsultas(ComprasPage.INFORMES.COMPRAS_POR_FECHA);
    iframe = page.frameLocator('iframe');
  });
  ...
  test('Generar doc de compras por fecha', async () => {
