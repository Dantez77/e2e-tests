...
test.describe.serial('Libro de ventas a consumidor final', () => {
  let page;
  let context;
  let iframe;
  ...
  test.beforeEach(async () => {
    ...
    await ventasPage.goToInformesYconsultas(VentasPage.INFORMES.LIBRO_VENTAS_CONSUMIDOR_FINAL); 
    iframe = page.frameLocator('iframe');
  });
  ...
  test('Libro de ventas a consumidor final', async () => {
