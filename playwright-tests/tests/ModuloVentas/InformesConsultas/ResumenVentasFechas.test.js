...
test.describe.serial('Resumen de ventas entre fechas', () => {
  let page;
  let context;
  let iframe;
  ...
  test.beforeEach(async () => {
    ...
    await ventasPage.goToInformesYconsultas(VentasPage.INFORMES.RESUMEN_VENTAS_ENTRE_FECHAS); 
    iframe = page.frameLocator('iframe');
  });
  ...
  test('Resumen de ventas entre fechas', async () => {
