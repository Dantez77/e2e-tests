...
test.describe('Existencias por item', () => {
  let page;
  let context;
  let iframe;
  ...
  test.beforeEach(async () => {
    ...
    await inventarioPage.goToInformesYconsultas(InventarioPage.INFORMES.EXISTENCIAS_POR_ITEM);
    iframe = page.frameLocator('iframe');
  });
  ...
  test('Generar costos de existencias', async () => {
    await iframe.getByRole('textbox', { name: 'Item(s)' }).click();
